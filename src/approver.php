...
<!--  the rest of laura's code here vvvv -->
<!DOCTYPE html>
<html lang="en-US">
<!--HEAD******************************************************************************** -->
...
<head>
  ...
  <title> SASN IT ACCESS REQUEST FORM APPROVER LIST</title>
</head>
...
<body>
  ...
  <div class="form-container">
    ...
    <ul class="tabs">
      ...
      <li data-tab-target="#pending" class="tab">Pending Approval</li>
    ...
    <div class="tab-content">
      ...
      <a href="#" class="next round">&#8250;</a> -->
          ...
          <div class="drop-down-section">
            ...
            <div class="container">
              ...
              <select name="reles-names" id="roles-names">
          ...
          <div class="table-information">
            <table class="table2" id = tableHeaders>
              <tr>
                <th id = "subDate">Date Sub</th>
                <th id = "effDate">Date Eff</th>
                <th id = "netID">NetID</th>
                <th id = "fName">First Name</th>
                <th id = "lname">Last Name</th>
                <th id = "system">IT System</th>
                <th id = "roles">Roles</th>
                <!-- is not just inprocess but, aproved by ..., ast thing thing that the form went throw-->
                <th id = "schoolAndDept">School & Department</th>
                <th id = "supName">Supervisor's Name</th>
              ...
              // need to check the user currently logged in to determine what the user is allowed to see,
              // what they need to approve or deny, and their "access level"
              ...
              function displayArrayData($result){
                $row = mysqli_fetch_assoc($result);
                $keys = array_keys($row);
                echo "<tr>";
                  echo "<pre>";
                  echo "<td>" . print_r($keys) . "</td>";
                  echo "</pre>";
                  echo "<pre>";
              ...
              function displayTableInfo($result){
                while($row = mysqli_fetch_assoc($result)) {
                  echo "<tr>";
                    ...
                    echo "<td>" . $row["schoolName"] . " - " . $row["debtName"]. "</td>";
                    echo "<td>" . $row["supervisorName"] . "</td>";
                    echo "<td>" . $row["actionName"] . "</td>";
                    echo "<td>" . date('m-d-Y', strtotime($row["action"])) . "</td>";
                  echo "</tr>";
                }
              }
              ...
              /* 
              // Compares the table dimension's id with the names of the current array row.
              while ($row = mysqli_fetch_assoc($result)){
                echo "<tr>";
                  for when ($row[table header name] == title header name){
                    echo "<td>" . $row[table header name] information . "</td>";
                  }
              ...
              */ 
              ...
              while ($row = mysqli_fetch_assoc($result)){
                ...
                for ($i = 0; $i < count($row); $i++){
                  if(strtotime(array_keys($row)[$i])){
                    echo "<td>" . date('m-d-Y', strtotime(array_keys($row)[$i])) . "</td>";
                  } else {
                    if(array_keys($row)[$i] == "html table id names"){
                      echo "<td>". array_keys($row)[$i] ."</td>";
                    }
                    // w/o the "if-statement" it is printing all the index names of the array $row.
                    // need the values not the names. And for only the titles shown.
                  }
                }
                echo "</tr>";
              } 
              ...
              */
              ...
              // $elementID = $table->getElementById("td");
              ?>
              ...
              <tr>
                ...
                <td>START</td>
                <td> </td>
                <td>SASN - Math Department</td>
                <td> John Smith</td>
                <td>Supervisor signed</td>
                <td>mm-dd-yyyy</td>
              </tr>
              <tr>
                <td>mm-dd-yyyy</td>
              ...
              <tr>
                ...
                <td>SASN - Economy Department</td>
                <td> Grace Smith</td>
                <td> SASN Dean (Name and last name) signed</td>
                <td>mm-dd-yyyy</td>
              </tr>
              <tr>
                <td>mm-dd-yyyy</td>
      ...
      <div id="pending" data-tab-content>
