...
class MysqliDb
{
    ...
    public function connect()
    {
        ...
        $this->_mysqli = new mysqli ($this->host, $this->username, $this->password, $this->db, $this->port)
        or dieGracefully('There was a problem connecting to the database');
	 ...
	 */
	public function queryUnprepared($query) //Changed from private to public to allow manual load data infile
	{	
		// Execute query
